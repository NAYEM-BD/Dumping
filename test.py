...
def mahadi():
    ...
    if __Mahadi__ in ['A','a','01','1']:
       ...
       # os.system('xdg-open https://www.facebook.com/M4HADI.143')
        ...
        os.system('xdg-open https://wa.me/message/LJM7NRTYTMUAC1/')
...
def resul():
    os.system('clear')
    print(logo)
    print(' \033[96;1m[\033[96;1m1\033[96;1m] CHECK 𝐃𝐮𝐦𝐛 1')
    print(' \033[95;1m[\033[95;1m2\033[95;1m] CHECK 𝐃𝐮𝐦𝐛 2 (ᴮᵉˢᵗ)')
    print(' \033[94;1m[\033[94;1m3\033[94;1m] EXIT ')
    print('\033[0;91m==================')
    kz = input(' \033[95;1m[\033[95;1m•\033[95;1m]CHOOSE : ')
    if kz in ['1','01']:
        os.system('python DUMX.py')
        os.system('python DUMX.py')
    elif kz in ['2','02']:
        os.system('import FILE.cpython-311')
        os.system('import FILE.cpython-311')
def __Hasan__():
    global oks,cps
    os.system('clear');logo()
